                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select rounded-0 p-2" id="colorPrenda" name="colorPrenda" required>
                                    <?php foreach ($listaColores as $color) { ?>
                                        ...
                                        <select name="" id=""><a href="<?php echo crearUrl('color', $color["nombre"]); ?>" class="color-swatch border border-dark" style="background-color: <?php echo $color["valor_hexadecimal"] ?>;" title="<?php echo $color["nombre"] ?>"></a></select>
