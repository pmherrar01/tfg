        ...
        <aside class="col-lg-3 d-none d-lg-block mb-4">
            <div class="sticky-top" style="top: 100px; z-index: 1;">
                ...
                <div class="mb-5 pb-4 border-bottom">
                    <h5 class="fw-bold text-uppercase mb-3 m-0" style="font-size: 0.95rem;">Ordenar por</h5>
                    <select class="form-select border-dark rounded-0 py-2 text-muted shadow-none" id="ordenarCatalogo" onchange="if(this.value) window.location.href='?orden=' + this.value;">
                        <option value="" selected disabled>Seleccionar...</option>
                        <option value="fecha_desc">Fecha: de más recientes a más antiguos</option>
                        <option value="fecha_asc">Fecha de más antiguos a más recientes</option>
