            ...
            <div class="row g-4">
                ...
                if (!empty($listaProductos)) {
                    foreach ($listaProductos as $prenda) {
                        ...
                        // CORRECCIÓN 1: La variable correcta es $imagenModel
                        $listaImagenesColor = $imagenModel->listarImagenesPorColor($prenda["id"], $prenda["color_id"]);
                        $fotoHover = count($listaImagenesColor) > 1 ? $listaImagenesColor["url_imagen"] : $prenda["url_imagen"];
                ?>
                        ...
                        <div class="col-6 col-md-4 mb-4">
                            <div class="card product-card border-0 bg-transparent h-100 position-relative d-flex flex-column">
                                ...
                                ?>
                                <button type="button" class="btn btn-favorito btn-toggle-favorito btn-favorito-custom btn-favorito-std position-absolute top-0 end-0 m-2 rounded-0 d-flex justify-content-center align-items-center" style="z-index: 10;" data-id="<?= $prenda['id'] ?>" data-color="<?= $prenda['color_id'] ?>">
                                ...
                                <div class="position-relative overflow-hidden group-hover-wrapper">
                                    <a href="fichaProducto.php?idPrenda=<?php echo $prenda["id"] ?>&color=<?php echo $prenda['color_id']; ?>" class="text-decoration-none text-dark d-block">
                                        <div class="img-wrapper position-relative">
                                            <img src="<?php echo $prenda["url_imagen"]; ?>" class="card-img-top img-principal rounded-0" alt="Prenda" style="height: 380px; object-fit: cover;">
                                            <img src="<?php echo $fotoHover; ?>" class="card-img-top img-hover position-absolute top-0 start-0 w-100 h-100 rounded-0" alt="Prenda Hover" style="height: 380px; object-fit: cover;">
                                        </div>
                                ...
                                <div class="mt-auto px-1 pt-2 w-100 text-center">
