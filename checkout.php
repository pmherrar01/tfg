...
<main class="container my-5 py-5 mt-5" style="min-height: 60vh;">
    ...
    <div class="row g-5">
        <div class="col-lg-7">
            ...
            ?>
                <div class="alert alert-danger rounded-0 border-0 border-start border-danger border-4 p-4 shadow-sm" role="alert">
                    <h5 class="fw-bold text-uppercase mb-3"><i class="bi bi-exclamation-triangle-fill me-2"></i> Faltan datos de envío</h5>
                    <p class="mb-4">Para poder enviarte el pedido, necesitamos que completes tu dirección postal y ciudad en tu perfil.</p>
                    <a href="perfil.php" class="btn btn-dark rounded-0 px-4 py-2 text-uppercase fw-bold ls-1">Ir a mi Perfil a rellenarlos</a>
                </div>
            ...
            <?php else: ?>
                <div class="card border-0 bg-light rounded-0 p-4 shadow-sm">
                    ...
                    <p class="mb-1 text-muted"><i class="bi bi-mailbox me-2"></i><strong>C.P.:</strong> <?php echo $datosComprador['codigoPostal'] ?? 'No especificado'; ?></p>
